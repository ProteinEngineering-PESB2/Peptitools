...
from peptitools.modules.machine_learning_tools.clustering_methods.alignment_clustering import (
    AlignmentClustering,
)
from peptitools.modules.machine_learning_tools.clustering_methods.clustering_process import (
    Clustering,
)
from peptitools.modules.machine_learning_tools.clustering_methods.distance_clustering import (
    DistanceClustering,
)
...
from peptitools.modules.machine_learning_tools.training_supervised_learning.supervised_learning import (
    SupervisedLearning,
)
...
def api_supervised_learning():
    ...
    check = parse_request(
        ...
        True,
        "csv",
        task=json.loads(request.form["options"])["task"],
    )
    if check["status"] == "error":
        return parse_response(check, status_code=400)
