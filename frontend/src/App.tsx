...
import IC50 from "./pages/ic50";
import Solubility from "./pages/solubility";
import Immunomodularity from "./pages/immunomodularity";
        ...
        <>
          <BrowserRouter>
            <Routes loadingScreen={LoadingComponent}>
              ...
              <Route path={config.msa.route} element={<MultiAlignmentSequence />} loading />
              ...
              <Route path={config.ic50.route} element={<IC50 />} loading/>
              <Route path={config.solubility.route} element={<Solubility />} loading/>
              <Route path={config.immunomodularity.route} element={<Immunomodularity />} loading/>
